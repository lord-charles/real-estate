export const RecentOffers = [
  {
    ...
    amenities: [
      ...
      {
        icon: "/icons/swimming-pool-icon.png",
        name: "Swimming Pool",
      },
    ],
  },
...
export const ForSale = [
  ...
  },
  {
    ...
    time: Date.now() - 86400000, // A day (in milliseconds) before the current timestamp
    description: "2-Bedroom Single-Family Home in Central London",
    richDescription:
      "Experience urban living with this stylish 2-bedroom, 2-bathroom single-family home situated in the heart of London. The property offers a spacious living space, modern amenities, and easy access to city attractions, parks, and more. Live the city life with all the comforts of home.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Private Garage",
  ...
  },
  {
    ...
    time: Date.now() - 172800000, // Two days (in milliseconds) before the current timestamp
    description: "4-Bedroom Single-Family Home in Serene Mawanga",
    richDescription:
      "Discover the epitome of space and comfort with this spacious 4-bedroom single-family home in the serene Mawanga neighborhood. Offering 4.5 bathrooms, a generously sized living area, and a landscaped garden, this home is perfect for families seeking tranquility and convenience.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Two-Car Garage",
...
export const FeaturedData = [
  {
    ...
    name: "Colt Stelle",
    images: [
      "/assets/listings/l1.webp",
      "/assets/listings/l5.webp",
      "/assets/listings/l3.webp",
    ],
    students: 150,
    classes: 12,
    price: "Ksh 8,500",
    ...
    beds: 2,
    id: 300,
    description: "Spacious 2 BHK apartment in Section 58",
    richDescription:
      "Explore this spacious 2 BHK apartment in the vibrant Section 58 neighborhood. It's an ideal choice for families and working professionals. This modern apartment features two bedrooms, a comfortable living space, and two bathrooms. Enjoy the convenience of nearby schools, restaurants, and parks.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
  ...
  },
  {
    ...
    beds: 2,
    id: 301,
    description: "Charming 2 BHK villa in Lanet",
    richDescription:
      "Discover this charming 2 BHK villa in the peaceful Lanet neighborhood. It's the perfect place for your family to call home. With two bedrooms, a spacious living area, and two bathrooms, you'll have all the space you need. Enjoy a serene environment while being close to essential amenities.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
  ...
  {
    heading: "1 BHK Independent House",
    heading2: "Pipeline",
    name: "Colt Stelle",
    images: [
      "/assets/listings/l3.webp",
      "/assets/listings/l6.webp",
      "/assets/listings/l4.webp",
    ],
    students: 120,
    classes: 12,
    price: "Ksh 8,900",
    ...
    beds: 2,
    id: 302,
    description: "Cozy 1 BHK independent house in Pipeline",
    richDescription:
      "This 1 BHK independent house in the Pipeline area is a fantastic rental option. With two bedrooms, a cozy living space, and two bathrooms, this home is perfect for small families or couples. Enjoy the convenience of nearby schools, shopping centers, and parks.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
      ...
      {
        icon: "/icons/terrace-icon.png",
        name: "Terrace",
      },
      {
        icon: "/icons/laundry-icon.png",
        name: "Laundry",
      },
    ],
  },
  {
    ...
    beds: 1,
    id: 303,
    description: "Stylish 2 BHK apartment in Elementaita",
    richDescription:
      "Welcome to this stylish 2 BHK apartment in Elementaita, designed for modern living. With two bedrooms, a well-appointed living area, and two bathrooms, this apartment is perfect for professionals or couples. Experience comfortable living with amenities and schools close by.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
  ...
  },
  {
    ...
    beds: 2,
    id: 304,
    description: "Stunning 2 BHK villa near the White House",
    richDescription:
      "This stunning 2 BHK villa near the White House is a dream home for those seeking elegance and comfort. It offers two spacious bedrooms, a luxurious living area, and two bathrooms. This villa is the perfect retreat while being conveniently located for schools and recreational activities.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
  ...
  },
  {
    ...
    beds: 2,
    id: 305,
    description: "Elegant 2 BHK villa near the White House",
    richDescription:
      "Explore this elegant 2 BHK villa near the White House, an ideal residence for those who appreciate luxury and style. With two bedrooms, a spacious living area, and two bathrooms, this villa offers comfort and convenience. Enjoy easy access to schools, parks, and shopping centers.",
    amenities: [
      {
        icon: "/icons/parking-icon.png",
        name: "Parking",
