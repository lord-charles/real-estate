  ...
  render() {
    ...
    return (
      <div id="featured listings">
        <div className="mx-auto max-w-7xl sm:py-8 px-4 lg:px-8  relative">
          <div className="sm:flex justify-between items-center">
            <h3 className="text-midnightblue text-2xl lg:text-55xl font-semibold mb-5 sm:mb-0">
              FEATURED LISTING
            </h3>
            <Link
              href={"/"}
          ...
          <div className="absolute left-[40%] lg:hidden md:hidden xxxs:visible bottom-0 z-[9999]">
            <Lottie
