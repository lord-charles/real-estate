    ...
    <main className="flex flex-col flex-1">
      ...
      <div className="max-w-6xl px-6 pb-20 mx-auto mt-12 border bg-emerland-50 pt-14 md:px-14">
        ...
        <div className="mt-6 space-y-6 md:flex md:space-x-10 md:space-y-0">
          {/* Contact Form */}
          <form
            className="space-y-6 md:flex md:w-2/3 md:space-x-6 md:space-y-0"
          ...
          >
            ...
            <div className="md:w-1/2">
              <textarea
                ...
                required
                className="w-full h-32 py-3 border-gray-300"
              ></textarea>
            </div>
          ...
          <div className="space-y-6 md:w-1/3">
            <div className="space-y-1">
              ...
              <p className="text-gray-600">info.@rifthomes.co.ke</p>
            </div>
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-gray-900">Phone</h4>
              <p className="text-gray-600">0740315545</p>
            </div>
            <div className="space-y-1">
