          ...
          <div>
            <div className="grid grid-rows-2 gap-4 mt-10 md:grid-cols-2 lg:grid-cols-3 aspect-[16/7]">
              <div className="relative col-span-2 row-span-2">
                <Image
                  src={ForRent[details - 100].images[0]}
                  alt="Property 5"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={ForRent[details - 100].images[1]}
                  alt="Property 6"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={ForRent[details - 100].images[2]}
                  alt="Property 9"
                  layout="fill"
                  objectFit="cover"
                />
          ...
          <div className="md:px-20">
            <div className="pt-20">
              ...
              <p className="mt-4 leading-9 text-gray-600">
                {ForRent[details - 100].description}
              </p>
            </div>
            <div className="pt-10">
              <h4 className="text-xl uppercase font-heading">Amenities</h4>
              <div className="grid gap-6 mt-8 md:grid-cols-3">
                {ForRent[details - 100].amenities.map((item, index) => {
                  return (
            ...
            <div className="mt-10">
              ...
              <p className="mt-2 text-gray-600">
                {ForRent[details - 100].richDescription}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="grid gap-8 mt-5 lg:grid-cols-3  md:grid-cols-3 xxxs:grid-cols-1 place-items-center">
              {ForRent[details - 100].images.map((item, index) => {
                return (
