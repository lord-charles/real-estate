...
import { AirbnbsData } from "@/utils/data";
      ...
      <div className="bg-brand-accent relative mt-0">
        <div className="relative max-w-6xl pt-16 pb-10 mx-auto md:pt-20">
          <h1 className="md:text-3xl lg:text-3xl  xxxs:text-2xl  leading-10 text-center uppercase font-heading">
            {AirbnbsData[details - 400].heading1}
          </h1>
          <p className="mt-2 text-center text-gray-700">
            {AirbnbsData[details - 400].heading2}
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div>
            <div className="grid grid-rows-2 gap-4 mt-10 md:grid-cols-2 lg:grid-cols-3 aspect-[16/7]">
              <div className="relative col-span-2 row-span-2">
                <Image
                  src={AirbnbsData[details - 400].images[0]}
                  alt="Property 5"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={AirbnbsData[details - 400].images[1]}
                  alt="Property 6"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={AirbnbsData[details - 400].images[2]}
                  alt="Property 9"
                  layout="fill"
                  objectFit="cover"
                />
          ...
          <div className="md:px-20">
            <div className="pt-20">
              ...
              <p className="mt-4 leading-9 text-gray-600">
                {AirbnbsData[details - 400].description}
              </p>
            </div>
            <div className="pt-10">
              <h4 className="text-xl uppercase font-heading">Amenities</h4>
              <div className="grid gap-6 mt-8 md:grid-cols-3">
                {AirbnbsData[details - 400].amenities.map((item, index) => {
                  return (
            ...
            <div className="mt-10">
              ...
              <p className="mt-2 text-gray-600">
                {AirbnbsData[details - 400].richDescription}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="grid gap-8 mt-5 lg:grid-cols-3  md:grid-cols-3 xxxs:grid-cols-1 place-items-center">
              {AirbnbsData[details - 400].images.map((item, index) => {
                return (
          ...
          <div class="pt-20">
            ...
            <div class="relative mt-6 aspect-video">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d37633.65975720456!2d-73.88896464740062!3d40.67982311122512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25c445213731d%3A0x19566ced90a1b555!2sCypress%20Hills%2C%20Brooklyn%2C%20NY%2011233%2C%20USA!5e0!3m2!1sen!2sin!4v1654532259365!5m2!1sen!2sin"
                width="1152"
                height="648"
