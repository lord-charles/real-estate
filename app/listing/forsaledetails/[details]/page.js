...
const PropertyDetail = ({ params }) => {
  ...
  console.log(details);
  const filteredForSale = ForSale.filter((item) => item.id !== details);
      ...
      <div className="bg-brand-accent relative mt-0">
        <div className="relative max-w-6xl pt-16 pb-10 mx-auto md:pt-20">
          <h1 className="md:text-3xl lg:text-3xl  xxxs:text-2xl  leading-10 text-center uppercase font-heading">
            {ForSale[details - 1].heading}
          </h1>
          <p className="mt-2 text-center text-gray-700">
            {ForSale[details - 1].heading2}
          </p>
        </div>
          ...
          <div>
            <div className="grid grid-rows-2 gap-4 mt-10 md:grid-cols-2 lg:grid-cols-3 aspect-[16/7]">
              <div className="relative col-span-2 row-span-2">
                <Image
                  src={ForSale[details - 1].images[0]}
                  alt="Property 5"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={ForSale[details - 1].images[1]}
                  alt="Property 6"
                  layout="fill"
                  objectFit="cover"
                />
              ...
              <div className="relative">
                <Image
                  src={ForSale[details - 1].images[2]}
                  alt="Property 9"
                  layout="fill"
                  objectFit="cover"
                />
          ...
          <div className="md:px-20">
            <div className="pt-20">
              ...
              <p className="mt-4 leading-9 text-gray-600">
                {ForSale[details - 1].description}
              </p>
            </div>
            <div className="pt-10">
              <h4 className="text-xl uppercase font-heading">Amenities</h4>
              <div className="grid gap-6 mt-8 md:grid-cols-3">
                {ForSale[details - 1].amenities.map((item, index) => {
                  return (
            ...
            <div className="mt-10">
              ...
              <p className="mt-2 text-gray-600">
                {ForSale[details - 1].richDescription}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="grid gap-8 mt-5 lg:grid-cols-3  md:grid-cols-3 xxxs:grid-cols-1 place-items-center">
              {ForSale[details - 1].images.map((item, index) => {
                return (
